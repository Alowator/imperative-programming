# lecture9-reinterpr-memory-struct-files
...
Windows: — два символа 0x0D и 0x0A, они же 13, 10
Linux: — один символ 0x0A, или 10 (символ перевода строки)
старый Mac: – один символ 0x0D, или 13 (символ возврата каретки)
...
Когда вы пишите в файл, каждый символ ‘’ заменяется на перевод строк, принятый в вашей системе.
