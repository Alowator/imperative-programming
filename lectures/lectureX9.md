...
1. Алгоритм работает при любых весах, хотя циклов отр. веса быть не должно.
2. Время работы O(V^3).
Способ хранения графа не важен: т.к. сам алгоритм неизбежно работает на матрице, лучше всего подходит матрица смежности.
3. Как найти сам путь из u в v:
...
4. Алгоритм поиска транзитивного замыкания для отношения является частным случаем алгоритма Флойда-Уоршалла.
