# lectureX1 - Арифметика по модулю, Быстрое возведение в степень, Алгоритм Евклида, Поле вычетов
...
2) в цикле по k поддерживаем a(2k):
a) если k-ый бит n равен 1, то домножаем текущий результат R на a(2k)
б) для перехода к след. k возводим текущее a(2k) в квадрат
